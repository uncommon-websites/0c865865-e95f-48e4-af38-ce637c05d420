...
<main class="min-h-screen bg-background text-foreground flex items-center justify-center">
	<div class="container-custom text-center">
		<div class="flex justify-center mb-8">
			<svg width="48" height="60" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-foreground opacity-50">
		...
		<h1 class="text-4xl font-medium mb-4">Error {page.status}</h1>
		<p class="text-muted mb-8">{page.error?.message ?? "Something went wrong."}</p>
		<a href="/" class="inline-flex items-center gap-2 border border-border px-4 py-2 text-xs font-mono uppercase hover:bg-primary-50 transition-colors">
			Go back home
